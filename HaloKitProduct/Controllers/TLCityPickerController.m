...
{
    if (_data == nil) {
        if ( [_flagVc isEqualToString: @"BGEditpetVC"]) {
            
            
            NSArray *array = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"CateData" ofType:@"plist"]];
            ...
            for (NSDictionary *groupDic in array) {
                ...
                for (NSDictionary *dic in [groupDic objectForKey:@"citys"]) {
                    ...
                    city.weight = [dic objectForKey:@"weight"];
...
- (NSMutableArray *) arraySection
{
    if (_arraySection == nil) {
        _arraySection = [[NSMutableArray alloc] initWithObjects:UITableViewIndexSearch,@"最热", nil];
    }
